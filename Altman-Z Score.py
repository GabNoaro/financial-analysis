...
The Z-score uses multiple corporate income and balance sheet values to measure the financial health of a company. [Wikipedia]
...
def calculate_altman_zscore(symbol, balance_sheet, income_statement, industry='non_manufacturer'):
    ...
    revenue = income_statement['revenue'] #get revenue
...
zscore_df.to_csv('altman_zscore_results.csv', index=False)
